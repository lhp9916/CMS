        ...
        i(a.edit.doc).contextmenu(function (c) {
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !==
                    ...
                    if (b.length > 0) {
                        c.preventDefault();
                        var k = i(a.edit.iframe).pos(), w = ab({
                            x: k.x + c.clientX,
                            y: k.y + c.clientY,
                            width: g,
    ...
    if (!b.KindEditor) {
        ...
        Ab("core", function (a) {
            ...
            c.clickToolbar("formatblock", function () {
                var a = c.lang("formatblock.formatBlock"), b = {
                    h1: 28,
                    h2: 24,
                    h3: 18,
                    H4: 14,
                    p: 12
                }, d = c.cmd.val("formatblock"), g = c.createMenu({
                    name: "formatblock",
            ...
            c.clickToolbar("fontsize",
                function () {
                    ...
                    h(c.fontSizeTable, function (d, g) {
                        b.addItem({
                            title: '<span style="font-size:' + g + ';" unselectable="on">' + g + "</span>",
                            height: l(g) + 12,
                            checked: a === g,
                            click: function () {
            ...
            h("forecolor,hilitecolor".split(","), function (a, b) {
                c.clickToolbar(b, function () {
                    c.createMenu({
                        name: b,
                        selectedColor: c.cmd.val(b) || "default",
                        colors: c.colorTable,
                        click: function (a) {
                            c.exec(b, a).hideMenu()
                        }
...
KindEditor.plugin("image", function (b) {
    ...
    d.plugin.imageDialog = function (f) {
        ...
        j && q ? (H = b.tabs({
            ...
            title: p.localImage,
            panel: b(".tab2", E)
        }), H.select(A)) : j ? b(".tab1", E).show() : q && b(".tab2", E).show();
        var U = b.uploadbutton({
            button: b(".ke-upload-button", E)[0],
            fieldName: s,
            form: b(".ke-form", E),
            target: G,
            width: 60,
